// Rechnungsdarstellung (ViewModel) für Ansicht und PDF. Liest ausschließlich Invoice und InvoiceItems,
// nichts wird nachgerechnet oder aus Buchung, Vertrag oder Zusatzkosten nachgeladen. Frei von Server-Importen.
...
type InvoiceFull = Prisma.InvoiceGetPayload<{ include: { items: true } }>;

export function buildInvoiceDocument(inv: InvoiceFull, refs: { contractNumber: string | null; bookingNumber: string | null; returnNumber: string | null }): InvoiceDocumentData {
